...
// Draws the "watermark camera" style corner timestamp badge (large HH:mm,
// accent divider, date + weekday column) near the bottom-left (position 0) or
// bottom-right (position 1) corner of the surface. The timestamp is resolved
// at render time.
